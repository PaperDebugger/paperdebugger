...
type CreateConversationMessageRequest struct {
	...
	LanguageModel    LanguageModel     `protobuf:"varint,3,opt,name=language_model,json=languageModel,proto3,enum=chat.v1.LanguageModel" json:"language_model,omitempty"` // deprecated: use model_slug instead
	ModelSlug        string            `protobuf:"bytes,7,opt,name=model_slug,json=modelSlug,proto3" json:"model_slug,omitempty"`                                         // new: model slug string
