 ...
 */
export type StreamEventPayload<T extends StreamEvent["type"]> = Extract<StreamEvent, { type: T }>["payload"];
 ...
 */
export type MessageRole = "assistant" | "toolCallPrepareArguments" | "toolCall" | "user" | "system" | "unknown";
