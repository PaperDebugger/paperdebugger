import { Conversation, Message, MessageTypeAssistant, MessageTypeToolCall, MessageTypeToolCallPrepareArguments, MessageTypeUnknown, MessageTypeUser } from "../../pkg/gen/apiclient/chat/v1/chat_pb";
...
export function getPrevUserMessage(
    messages: Message[],
    currentIndex: number,
): MessageTypeUser | undefined {
