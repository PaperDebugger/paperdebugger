...
export const SelectedTextIndicator = () => {
    ...
    return (
        <div className="px-2 relative" onClick={onOpen}>
            <div className={cn("pd-selected-text-indicator", heightCollapseRequired || minimalistMode ? "px-2 py-1 text-[0.65rem]" : "p-2 text-xs")} style={{ animation: 'blink 0.5s ease-in-out' }}>
