...
import { 
  useGetProjectInstructionsQuery,
  useUpsertProjectInstructionsMutation 
} from "../../query/index";
...
export function ProjectInstructions() {
  ...
  const handleProjectInstructionChange = useCallback((e: React.ChangeEvent<HTMLTextAreaElement>) => {
    ...
    <SettingsSectionContainer>
      ...
      <div className="space-y-2">
        <textarea
          ...
          className={cn("flex-grow resize-none noselect focus:outline-none rnd-cancel px-2 py-1 border border-gray-200 rounded-md w-full")}
          style={{ 
            fontSize: "12px", 
