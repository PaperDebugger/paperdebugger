...
export const UISettings = () => {
  const { settings, isUpdating, updateSettings, disableLineWrap, setDisableLineWrap, minimalistMode, setMinimalistMode, hideAvatar, setHideAvatar } = useSettingStore();
    ...
    <SettingsSectionContainer>
      ...
      <SettingItem
        ...
        onSelectChange={(selected) =>
          updateSettings({ showShortcutsAfterSelection: selected })
        }
      />
      <SettingItem
        ...
        onSelectChange={(selected) =>
          updateSettings({ fullWidthPaperDebuggerButton: selected })
        }
      />
      <SettingItem
