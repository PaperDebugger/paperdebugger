...
export const TopMenuButton = () => {
    ...
    return <div className="toolbar-item dropdown relative" id="paper-debugger-button" onContextMenu={event => handleContextMenu(event)}>
        <button className="btn btn-full-height flex gap-1 items-center justify-center ide-redesign-toolbar-dropdown-toggle-subdued ide-redesign-toolbar-button-subdued menu-bar-toggle" onClick={() => setIsOpen(!isOpen)}>
        ...
        {/* 位置重置菜单 */}
        <div className={`pd-context-menu noselect ${contextMenuVisible ? "show" : ""}`} style={{
            zIndex: 998
        }}>
