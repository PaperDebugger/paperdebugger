 ...
 * ```
 */
export function buildStreamRequest(params: StreamRequestParams): PlainMessage<CreateConversationMessageStreamRequest> {
  return {
    ...
    conversationType: params.conversationMode === "debug" ? ConversationType.DEBUG : ConversationType.UNSPECIFIED,
  };
}
 ...
 */
export function validateStreamRequestParams(params: Partial<StreamRequestParams>): { valid: boolean; error?: string } {
