...
export function fromStreamPartBegin(partBegin: StreamPartBegin): InternalMessage | null {
  ...
  switch (messageType.case) {
    case "assistant":
      return createAssistantMessage(partBegin.messageId, messageType.value.content, {
        reasoning: messageType.value.reasoning,
        modelSlug: messageType.value.modelSlug,
        status: "streaming",
      });
    ...
    case "toolCall":
      return createToolCallMessage(partBegin.messageId, messageType.value.name, messageType.value.args, {
        result: messageType.value.result,
        error: messageType.value.error,
        status: "streaming",
      });
    ...
    case "toolCallPrepareArguments":
      return createToolCallPrepareMessage(partBegin.messageId, messageType.value.name, messageType.value.args, {
        status: "streaming",
      });
 ...
 */
export function applyStreamPartEnd(partEnd: StreamPartEnd, existingMessage: InternalMessage): InternalMessage | null {
