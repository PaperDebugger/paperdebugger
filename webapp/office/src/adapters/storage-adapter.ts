 ...
 *
 * Note: Office Add-in uses standard localStorage (same as browser).
 * Office.context.roamingSettings is Outlook-only and not supported in Word.
 */
...
/**
 * Create storage adapter for browser/Office environment
 */
