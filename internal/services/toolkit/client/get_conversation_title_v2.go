...
func (a *AIClientV2) GetConversationTitleV2(ctx context.Context, userID bson.ObjectID, projectID string, inappChatHistory []*chatv2.Message, llmProvider *models.LLMProviderConfig) (string, error) {
	...
	_, resp, _, err := a.ChatCompletionV2(ctx, userID, projectID, "gpt-5-nano", OpenAIChatHistory{
