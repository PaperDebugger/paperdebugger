...
XTRAMCP_CROSSREF_EMAIL_ADDRESS=${CROSSREF_EMAIL_ADDRESS:-dummy-crossref-email-address}
XTRAMCP_DOI_EMAIL_ADDRESS=${DOI_EMAIL_ADDRESS:-dummy-doi-email-address}
XTRAMCP_ARXIV_METADATA_DB_URL=${ARXIV_METADATA_DB_URL:-postgresql://dummy-arxiv-metadata-db-url}
XTRAMCP_MONGO_URI=${MONGO_URI:-mongodb://dummy-mongo-uri}
